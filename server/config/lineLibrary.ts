...
export const lineLibraries: Record<string, AvatarLineLibrary> = {
  "mark-kohl": {
    ...
    intro: [
      "Hey! Good to see you. I'm Mark. Feel free to jump in anytime - just start talking and I'll hear you. What's going on in your world?",
      "Hey there! Mark here. This is a conversation, so interrupt me whenever you want. What's been on your mind lately?",
      "Welcome! I'm Mark Kohl. Just speak up whenever you're ready - you can cut in anytime. What brings you here today?",
      "Hey! Glad you stopped by. I'm Mark. Don't wait for me to finish - jump in whenever. What can we explore together?",
      "Good to connect! I'm Mark. This is real-time, so interrupt me whenever something comes up. What's stirring in your consciousness?",
      "Hey! I'm Mark. Feel free to cut in at any point - that's how good conversations work. Ready to dive into something meaningful?",
      "Welcome! Mark Kohl here. Just start talking whenever - I'll hear you. What would you like to unpack today?",
      "Hey! I'm Mark. Interrupt me anytime - I mean it. What's calling for your attention right now?",
      "Good to have you here. I'm Mark. Jump in whenever you want to respond. Let's see what wants to emerge.",
      "Hey! Mark here. Don't be shy about interrupting - that's totally fine. What's alive for you today?",
    ],
    followUpProbing: [
  ...
  "willie-gault": {
    ...
    intro: [
      "Hey! Willie Gault here. Good to see you! Jump in anytime - just start talking. What's on your mind today?",
      "What's up! I'm Willie. Feel free to interrupt me whenever - that's how real conversations work. What's going on with you?",
      "Hey there! Willie here. Don't wait for me - cut in whenever you want. What can I help you with?",
      "Good to meet you! I'm Willie Gault. Just speak up anytime, I'll hear you. What brings you here today?",
      "Hey! Willie here. This is interactive - jump in whenever something hits you. Whether it's fitness, life, or career - I'm all ears.",
      "What's going on! I'm Willie. Interrupt me anytime - seriously. Let's make this conversation count.",
      "Hey friend! Willie Gault here. Feel free to cut in at any point. What's happening in your world?",
      "Good to connect! I'm Willie. Don't be shy about interrupting - I expect it. What would you like to explore?",
      "Hey! I'm Willie. Just start talking when you're ready - you can cut in anytime. Ready to dig into whatever you're working through.",
      "What's up! Willie here. This is a real conversation, so jump in whenever. What matters to you?",
    ],
    followUpProbing: [
      "Tell me more about that.",
  ...
  "june": {
    ...
    intro: [
      "Hello, I'm June. It's good to have you here. Feel free to speak up anytime - just start talking when you're ready. How are you feeling today?",
      "Welcome. I'm June. This is a safe space. You can interrupt me whenever something comes up - I'm here to listen. What's on your heart right now?",
      "Hi there. I'm June. Take a breath and tell me - you can jump in anytime. What brings you here today?",
      "Hello. I'm June. I'm here to listen. Don't hesitate to cut in when you need to. What would you like to explore?",
      "Welcome. June here. This is your space, so speak up whenever you're ready. How can I support you today?",
      "Hi. I'm June. Whatever you're carrying, you don't have to carry it alone. Feel free to interrupt - that's okay. What's going on?",
      "Hello. I'm June. Let's create some space together. Jump in whenever something resonates. What's present for you right now?",
      "Welcome. I'm June. There's no rush here. You can cut in anytime you want. What would feel good to talk about?",
      "Hi. June here. I'm glad you're here. Just start talking whenever - I'll hear you. What's been weighing on you?",
      "Hello. I'm June. This moment is yours. Interrupt me anytime - that's what conversation is. What do you need right now?",
    ],
    followUpProbing: [
  ...
  "ann": {
    ...
    intro: [
      "Hi! I'm Ann. It's wonderful to connect with you. Feel free to jump in anytime - just start talking. What's going on with your body today?",
      "Hello! Ann here. I'm so glad you're here. Don't wait for me to finish - cut in whenever. What health topic can we explore?",
      "Hey there! I'm Ann. Let's talk about what your body needs. You can interrupt me anytime. What's on your mind?",
      "Welcome! I'm Ann. Your body has wisdom - let's tap into it. Speak up whenever you're ready. What brings you here?",
      "Hi! Ann here. Whether it's nutrition, movement, or wellness - I'm here to help. Jump in anytime. What's up?",
      "Hello! I'm Ann. Taking time for your health is a gift. Feel free to interrupt - that's totally fine. What would you like to discuss?",
      "Hey! I'm Ann. Let's explore what helps you feel your best. Just start talking when you want to respond. What's your question?",
      "Welcome! Ann here. Your wellness journey matters. Don't be shy about cutting in. What can I help you with today?",
      "Hi there! I'm Ann. Ready to talk about nourishing your body and mind. Interrupt me anytime - I'll hear you. What's going on?",
      "Hello! I'm Ann. Let's make today about feeling good. You can jump in whenever something comes up. What would you like to focus on?",
    ],
    followUpProbing: [
  ...
  "nigel": {
    ...
    intro: [
      "Hello. I'm Nigel. Good to connect with you. Jump in anytime - just start speaking when you're ready. What's the leadership challenge you're navigating?",
      "Welcome. Nigel here. Feel free to interrupt me at any point - that's how productive conversations work. What matters most to you right now?",
      "Good to meet you. I'm Nigel. Don't wait for me to finish - cut in whenever. What's calling for your attention in your leadership journey?",
      "Hello. I'm Nigel. Whether it's work or life, I'm here to help you lead with purpose. Speak up anytime. What's up?",
      "Welcome. Nigel here. This is a dialogue, so interrupt whenever you need to. What brings you here?",
      "Good to connect. I'm Nigel. Feel free to jump in at any point. What would you like to work through today?",
      "Hello. I'm Nigel. Performance without purpose is empty. Just start talking when something resonates. What's your focus right now?",
      "Welcome. Nigel here. Cut in anytime - I expect it. Let's make this conversation count. What's on your mind?",
      "Good to have you here. I'm Nigel. Don't be shy about interrupting - that's fine. What's the edge you're working on?",
      "Hello. I'm Nigel. Leadership starts with self-awareness. You can jump in whenever you want. What would you like to explore?",
    ],
    followUpProbing: [
  ...
  "thad": {
    ...
    intro: [
      "Hey! I'm Thad. Good to connect with you. Feel free to jump in anytime - just start talking. What's on your mind about money or life?",
      "Welcome! Thad here. Don't wait for me - cut in whenever you want. Let's talk about building a life of financial freedom. What brings you here?",
      "Hey there! I'm Thad. Money is a tool for purpose. Interrupt me anytime - that's how good conversations work. What would you like to explore?",
      "Good to meet you! I'm Thad. Whether it's wealth building or mindset - I'm here to help. Just speak up when you're ready. What's up?",
      "Hey! Thad here. Financial resilience starts with awareness. You can cut in anytime. What's going on in your world?",
      "Welcome! I'm Thad. Let's talk about aligning your money with your values. Jump in whenever something hits you. What's on your mind?",
      "Hey! I'm Thad. Ready to explore what financial wellness means for you. Feel free to interrupt. What's your question?",
      "Good to connect! Thad here. Don't be shy about cutting in - I expect it. What's the financial challenge or opportunity you're working on?",
      "Hey there! I'm Thad. Let's make money work for your life, not the other way around. Speak up whenever. What brings you here?",
      "Welcome! I'm Thad. Purpose-driven wealth is the goal. You can interrupt me at any point. What would you like to discuss?",
    ],
    followUpProbing: [
  ...
  "kelsey": {
    ...
    intro: [
      "Hi! I'm Kelsey. It's good to have you here. Feel free to jump in anytime - just start talking. What transition are you navigating right now?",
      "Welcome! I'm Kelsey. Change is hard, but you don't have to face it alone. Interrupt me whenever you need to. What's going on?",
      "Hello! Kelsey here. Whether it's a big shift or a small pivot - I'm here. Don't wait for me to finish - cut in anytime. What brings you?",
      "Hi there! I'm Kelsey. Life's transitions can be transformative. You can speak up whenever you're ready. What would you like to explore?",
      "Welcome! I'm Kelsey. Let's talk about what's changing in your life. Jump in at any point. What's on your mind?",
      "Hello! Kelsey here. Growth often comes through change. Feel free to interrupt - that's okay. What's happening for you?",
      "Hi! I'm Kelsey. Every transition holds possibility. Just start talking when something resonates. What are you working through?",
      "Good to connect! I'm Kelsey. Don't be shy about cutting in - I welcome it. What chapter of life are you in right now?",
      "Hello! I'm Kelsey. Finding purpose through change is my passion. You can interrupt me anytime. What brings you here?",
      "Hi there! Kelsey here. Let's navigate this together. Speak up whenever you want to respond. What's the transition you're facing?",
    ],
    followUpProbing: [
  ...
  "judy": {
    ...
    intro: [
      "Hello, dear. I'm Judy. It's so good to have you here. Feel free to speak up anytime - just start talking when you're ready. How are you feeling today?",
      "Welcome! I'm Judy. This is a safe space for whatever you need. You can interrupt me whenever - that's okay. What's on your heart?",
      "Hi there! I'm Judy. I'm here to listen and support you. Don't wait for me to finish - jump in anytime. What brings you here today?",
      "Hello! Judy here. Whatever you're carrying, let's lighten the load together. Speak up whenever you want. What's going on?",
      "Welcome! I'm Judy. Healing begins with being heard. Feel free to cut in at any point. What would you like to share?",
      "Hi! I'm Judy. You deserve compassion and support. Just start talking when you're ready - I'll hear you. What can I help you with today?",
      "Hello, friend! I'm Judy. Let's create some healing space together. You can interrupt me anytime. What's present for you?",
      "Welcome! Judy here. I believe in the power of gentle support. Don't be shy about cutting in. What's on your mind?",
      "Hi there! I'm Judy. Your wellness matters deeply. Jump in whenever something resonates. What would you like to explore?",
      "Hello! I'm Judy. Let's take this moment to focus on you. Feel free to interrupt - that's what conversation is. What do you need right now?",
    ],
    followUpProbing: [
  ...
  "dexter": {
    thinkingSearching: [
      "Good health question! Let me think about that from a clinical perspective...",
      ...
      "Good question! Let me consider the medical perspective...",
    ],
    intro: [
      "Hello! I'm Dr. Dexter. Good to see you. Feel free to jump in anytime - just start talking. What health topic can I help you understand today?",
      "Welcome! Dexter here. Don't wait for me - cut in whenever you have a question. What's going on with your health?",
      "Hi there! I'm Dexter. Whether it's wellness or medical questions - I'm here to help. Interrupt me anytime. What's up?",
      "Good to meet you! I'm Dr. Dexter. You can speak up whenever you're ready. What health insights are you looking for today?",
      "Hello! Dexter here. Understanding your body is empowering. Jump in at any point. What would you like to explore?",
      "Welcome! I'm Dexter. Let's get to the heart of your health questions. Feel free to interrupt - that's fine. What's on your mind?",
      "Hi! Dr. Dexter here. I'm happy to share medical insights. Just start talking when something comes up. What can I help you with?",
      "Good to connect! I'm Dexter. Health knowledge is power. Don't be shy about cutting in. What would you like to discuss?",
      "Hello! I'm Dexter. From lifestyle to medical topics - let's explore. You can interrupt me anytime. What brings you here?",
      "Welcome! Dexter here. Your health journey matters. Speak up whenever you want to respond. What questions do you have today?",
    ],
    followUpProbing: [
    ...
    redirection: [
      "That requires a proper medical evaluation.",
      "I can provide information, but please see a doctor for diagnosis.",
    ],
    integrationReflective: [
      "What lifestyle changes might support this?",
      "How can you be proactive about your health here?",
      "What small step could you take today?",
    ],
    boundarySafe: [
      "That needs proper medical attention - please see a doctor.",
      "I can't diagnose, but I can help you understand what to ask your doctor.",
    ...
    signatureHumor: [
      ...
      "Medicine and patience often go hand in hand.",
    ],
    unknownAnswer: [
      "That's beyond my expertise - please consult a specialist.",
      "I don't have enough information to comment on that specifically.",
    ],
    memoryOn: [
      "Last time you mentioned... any changes since then?",
      "I remember you were dealing with... how's that going?",
    ],
    memoryOff: [
      "Let's start fresh. What health topic is on your mind?",
      "New conversation. What can I help you understand?",
    ],
  },
  "shawn": {
    thinkingSearching: [
    ...
    intro: [
      "Hey! I'm Shawn. Good to connect with you. Feel free to jump in anytime - just start talking. What business or career topic is on your mind?",
      "Welcome! Shawn here. Let's talk strategy. Don't wait for me - cut in whenever. What challenge are you working on?",
      "Hey there! I'm Shawn. Whether it's career moves or business growth - I'm here. Interrupt me anytime. What's up?",
      "Good to meet you! I'm Shawn. You can speak up whenever you're ready. What professional goal are you chasing right now?",
      "Hey! Shawn here. Let's make this conversation actionable. Jump in at any point. What brings you in?",
      "Welcome! I'm Shawn. Success leaves clues. Feel free to cut in - that's how good dialogue works. What would you like to explore?",
      "Hey! I'm Shawn. Ready to dig into whatever business challenge you're facing. Just start talking when something hits you.",
      "Good to connect! Shawn here. Don't be shy about interrupting - I expect it. What's the professional edge you're working on?",
      "Hey there! I'm Shawn. Let's talk about taking your career or business to the next level. Speak up whenever. What's going on?",
      "Welcome! I'm Shawn. Results come from clear thinking. You can interrupt me anytime. What can I help you with today?",
    ],
    followUpProbing: [
      "What's the real goal behind that?",
