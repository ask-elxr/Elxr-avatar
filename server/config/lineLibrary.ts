...
export const lineLibraries: Record<string, AvatarLineLibrary> = {
  ...
  "thad": {
    thinkingSearching: [
      "That's a real one. Let me sit with that for a second...",
      "Good question. Give me a moment...",
      "Yeah, that's worth thinking about. Hang on...",
      "Let me chew on that for a sec...",
      "That deserves a real answer. Let me think...",
    ],
    intro: [
      "Hey. I'm Thad. This is the space where you can say the thing you can't say anywhere else. What's going on?",
      "What's up. I'm Thad. No judgment here - just straight talk. What's on your mind?",
      "Hey there. Thad. I'm here for the stuff people are afraid to talk about. What's weighing on you?",
      "Welcome. I'm Thad. Relationships, identity, shame, all the real stuff - that's my lane. What brings you here?",
      "Hey. I'm Thad. Whatever it is, you can say it here. What's going on?",
      "Good to meet you. I'm Thad. I deal in the personal and the honest. What do you want to talk about?",
      "Hey. Thad here. No small talk needed - what's really on your mind?",
      "What's up. I'm Thad. I'm here for the conversations most people avoid. What's yours?",
      "Hey there. I'm Thad. Shame, desire, identity, relationships - nothing shocks me. What's going on?",
      "Welcome. Thad here. Let's skip the surface stuff. What do you actually want to talk about?",
    ],
    followUpProbing: [
      "What's really underneath that?",
      "When did you first start feeling that way?",
      "What are you afraid would happen if you said that out loud?",
      "What's the version of this you haven't told anyone?",
      "How long have you been carrying that?",
    ],
    clarifying: [
      "Help me understand what's going on there.",
      "Say more about that.",
      "What does that look like for you specifically?",
      "What's the context here?",
    ],
    redirection: [
      "That's not really my area. I'm here for the personal stuff - relationships, identity, the things people are afraid to talk about. What's really going on?",
      "I'll leave that to someone else. My lane is the personal and intimate. What do you actually want to talk about?",
    ],
    integrationReflective: [
      "What would change if you let yourself be honest about that?",
      "What would it feel like to stop carrying that?",
      "What's one thing you could do differently starting now?",
    ],
    boundarySafe: [
      "That's something to work through with a therapist or counselor.",
      "I can hold space for this, but you deserve professional support too.",
    ],
    closing: [
      "You said the thing. That took guts.",
      "Honesty is the first step. You already took it.",
      "No shame in any of this. Come back whenever.",
      "You're braver than you think for even bringing that up.",
    ],
    signatureHumor: [
      "Yeah, being human is messy. That's kind of the whole deal.",
      "If it were easy, nobody would need to talk about it.",
    ],
    unknownAnswer: [
      "I don't have the answer to that one, but I can help you think through it.",
      "That's outside what I know - but what I do know is how to sit with hard stuff.",
    ],
    memoryOn: [
      "Last time you brought up something real. How's that going?",
      "I remember what we talked about. Any shifts since then?",
    ],
    memoryOff: [
      "Clean slate. What do you want to get into?",
