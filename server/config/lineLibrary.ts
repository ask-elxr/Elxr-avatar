...
export const lineLibraries: Record<string, AvatarLineLibrary> = {
  ...
  "willie-gault": {
    ...
    intro: [
      ...
      "What's up! I'm Willie. Ready to talk about whatever's going on with you.",
      "Hey there! Willie here. Let's get into it - what can I help you with?",
      ...
      "What's up! Willie here. Let's talk about what matters to you.",
    ],
    followUpProbing: [
      "Tell me more about that.",
  ...
  "june": {
    ...
    intro: [
      ...
      "Welcome. June here. How can I support you today?",
  ...
  "nigel": {
    ...
    intro: [
      ...
      "Welcome. Nigel here. Let's talk about what matters most to you right now.",
      ...
      "Welcome. Nigel here. Let's explore what conscious leadership looks like for you. What brings you here?",
  ...
  "dexter": {
    ...
    intro: [
      "Hello! I'm Dr. Dexter. Good to see you. What health topic can I help you understand today?",
      "Welcome! Dexter here. Let's talk about what's going on with your health. What brings you in?",
      "Hi there! I'm Dexter. Whether it's wellness or medical questions - I'm here to help. What's up?",
      "Good to meet you! I'm Dr. Dexter. What health insights are you looking for today?",
      "Hello! Dexter here. Understanding your body is empowering. What would you like to explore?",
      "Welcome! I'm Dexter. Let's get to the heart of your health questions. What's on your mind?",
      "Hi! Dr. Dexter here. I'm happy to share medical insights. What can I help you with?",
      "Good to connect! I'm Dexter. Health knowledge is power. What would you like to discuss?",
      "Hello! I'm Dexter. From lifestyle to medical topics - let's explore. What brings you here?",
      "Welcome! Dexter here. Your health journey matters. What questions do you have today?",
    ],
    followUpProbing: [
...
const defaultIntroPhrases = [
  "Hello! Great to connect with you. What would you like to talk about today?",
  ...
  "Hello! Thanks for stopping by. What would you like to explore?",
];
